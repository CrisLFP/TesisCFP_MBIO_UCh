...
load("~/Desktop/U_CHILE/MG_BIOESTADÍSTICA/TESIS/DATOS PÚBLICOS/PROYECCIONES_POBLACIONALES/pob_total_com_anio.RData")
```
...
dir.create("graficos_piramides", showWarnings = F)
...
# save(incidencias_tercil_oe2, file = "incidencias_tercil_oe2.RData")
```
